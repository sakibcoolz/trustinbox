...
func main() {
	...
	// TODO: Register analytics gRPC service handler
	// analyticsv1.RegisterAnalyticsServiceServer(srv, handler)

	// TODO: Start event consumer goroutine to aggregate metrics
