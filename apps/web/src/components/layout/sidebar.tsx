...
export function Sidebar() {
  ...
  return (
    <aside className="w-[72px] bg-bg-secondary border-r border-border-primary flex flex-col items-center py-3 shrink-0">
      {/* Logo */}
      ...
      <div className="flex flex-col items-center gap-1 w-full px-2">
        ...
        <div className="relative" ref={menuRef}>
          <button
            ...
            className={`relative w-10 h-10 rounded-full bg-gradient-to-br from-accent-blue to-accent-purple flex items-center justify-center text-white text-xs font-semibold transition-all group ${
              pathname === '/profile' ? 'ring-2 ring-accent-blue/60' : 'hover:ring-2 hover:ring-accent-blue/40'
            }`}
          >
            {initials}
            <span className="status-indicator bg-status-online" />
          </button>

          {menuOpen && (
            <div className="absolute bottom-0 left-full ml-2 w-52 bg-bg-elevated border border-border-secondary rounded-xl shadow-elevated z-50 overflow-hidden animate-fade-in">
              <div className="px-3 py-2.5 border-b border-border-primary">
                ...
                <p className="text-2xs text-accent-blue truncate">{user?.username || ''}</p>
              </div>
              <div className="py-1">
                <Link
                  href="/profile"
                  onClick={() => setMenuOpen(false)}
                  className="flex items-center gap-2.5 px-3 py-2 text-sm text-text-secondary hover:text-text-primary hover:bg-bg-hover transition-colors"
                >
              ...
              <div className="border-t border-border-primary py-1">
                <button
                  ...
                  className="flex items-center gap-2.5 px-3 py-2 w-full text-sm text-accent-red hover:bg-accent-red/10 transition-colors"
                >
