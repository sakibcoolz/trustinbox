    ...
    <>
      ...
      <div className="w-panel h-full flex flex-col bg-bg-secondary border-r border-border-primary shrink-0">
        ...
        <div className="flex-1 flex flex-col items-center justify-center px-4">
          ...
          <p className="text-sm text-text-muted text-center">No service providers yet</p>
          <p className="text-xs text-text-muted text-center mt-1">Verified service providers will appear here</p>
        </div>
      </div>
