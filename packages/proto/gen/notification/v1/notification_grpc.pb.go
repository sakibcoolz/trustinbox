...
func (c *notificationServiceClient) ArchiveNotification(ctx context.Context, in *ArchiveNotificationRequest, opts ...grpc.CallOption) (*ArchiveNotificationResponse, error) {
	...
	err := c.cc.Invoke(ctx, NotificationService_ArchiveNotification_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *notificationServiceClient) GetDeliveryStatus(ctx context.Context, in *GetDeliveryStatusRequest, opts ...grpc.CallOption) (*GetDeliveryStatusResponse, error) {
	...
	err := c.cc.Invoke(ctx, NotificationService_GetDeliveryStatus_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
