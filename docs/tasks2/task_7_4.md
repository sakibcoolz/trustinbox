...
- [x] Install Playwright:
  ...
  ```
- [x] Add `@playwright/test` to `apps/web/package.json` devDependencies
...
- [x] Create `apps/web/e2e/` directory
- [x] Create `apps/web/e2e/helpers.ts` — shared test utilities:
...
- [x] Create `apps/web/e2e/auth.spec.ts`:
...
- [x] Create `apps/web/e2e/inbox.spec.ts`:
  - **View notifications**:
...
- [x] Create `apps/web/e2e/callbacks.spec.ts`:
...
- [x] Create `apps/web/e2e/settings.spec.ts`:
  - **Privacy preferences**:
...
- [x] Create `apps/web/e2e/service-providers.spec.ts`:
  - **Browse directory**:
...
- [x] Create `apps/web/e2e/documents.spec.ts`:
...
- [x] Create `apps/web/e2e/conversations.spec.ts`:
...
- [x] Create `apps/web/e2e/dashboard.spec.ts`:
...
- [x] Run: `cd apps/web && npm run test:e2e`
...
- [x] `playwright.config.ts` created with correct baseURL (:3000), browsers, trace settings
- [x] `e2e/helpers.ts` provides login utility and GraphQL interceptors
- [x] `auth.spec.ts`: register, login, validation, logout, protected routes, localStorage tokens
- [x] `inbox.spec.ts`: view, tabs, mark-as-read, archive, detail
- [x] `callbacks.spec.ts`: view, approve w/ slot, reject w/ reason, detail, persistence
- [x] `settings.spec.ts`: privacy toggles, DND create/delete, availability slots, blocked providers
- [x] `service-providers.spec.ts`: browse, search, detail view, block, unblock
- [x] `documents.spec.ts`: list, download, filter, preview
- [x] `conversations.spec.ts`: list, thread, send message
- [x] `dashboard.spec.ts`: stats cards, widgets, navigation
- [x] `profile.spec.ts`: edit, save, avatar upload
